...
// MatchMakingDB의 Slave가 있는 주소. Slave만 추가되면 코드 수정없이(설정파일만 수정) 그 Slave에도 갈 수 있어야 한다.
$Matchmaking_SlaveCount = 2;
$Matchmaking_Slave_DB_IP[0] = '172.16.1.1';
$Matchmaking_Slave_DB_ID[0] = 'shDBslave';
$Matchmaking_Slave_DB_Password[0] = '034689';
$Matchmaking_Slave_DB_PORT[0] = 3306;
$Matchmaking_Slave_DB_Name[0] = 'matchmaking_status';

$Matchmaking_Slave_DB_IP[1] = '172.16.1.2';
$Matchmaking_Slave_DB_ID[1] = 'shDBslave';
