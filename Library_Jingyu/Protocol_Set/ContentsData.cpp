...
//--------------------------------------------------------------------
float	g_Data_ItemPoint_Redzone[16][2] = { {17,2},{2,72},{17,123},{3,162},{35,64},{43,105},{54,3},{61,37},{54,162},{92,147},{112,9},{109,31},{116,103},{111,160},{147,32},{148,148} };

//--------------------------------------------------------------------
// 레드존 외 구역의 포인트에는 지점마다 메디켓/헬멧/탄창 중 1개씩을 랜덤하게 생성 시킨다.
//
// 아래 지점들의 아이템은 누군가 획득하면 해당 자리에 10초 후 탄창 아이템을 생성 시킨다.
//--------------------------------------------------------------------
