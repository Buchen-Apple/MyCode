...
// ******************************
// shDB_Data.contents에서 정보를 Select해서 클라에게 돌려준다.
// ******************************
...
$Response['playtime'] = $SelectData['playtime'];
$Response['playcount'] = $SelectData['playcount'];
$Response['kill'] = $SelectData['kill'];
$Response['die'] = $SelectData['die'];
$Response['win'] = $SelectData['win'];
