...
#include "ObjectPool/Object_Pool_LockFreeVersion.h"	// 메모리풀 TLS버전 include
...
namespace Library_Jingyu
{
	...
	private:
		...
		// return : 없음
		void Room_BroadCast(ULONGLONG Array[], int ArraySize, CProtocolBuff_Net* SendBuff);
